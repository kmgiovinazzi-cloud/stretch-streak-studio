  ...
  return (
    <div className="px-5 pt-10 pb-8">
      <header className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">Ranked by current stretch streak.</p>
      </header>
        ...
        {rows.map((r, i) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="text-sm font-semibold leading-tight truncate">{r.display_name}</div>
            ...
            <div className="text-right">
              ...
              <div className="text-[10px] text-muted-foreground">best {r.longest_streak}</div>
            </div>
          </Link>
        ))}
